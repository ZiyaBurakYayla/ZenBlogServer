...
namespace ZenBlog.Persistence.İnterceptons
{
    public class AuditDbContextInterceptor : SaveChangesInterceptor
    {
        ...
        {
                    {
            EntityState.Added,AddeddBehavior
        },
                    {
                EntityState.Modified,ModifieddBehavior
            }
        };
        private static void AddeddBehavior(DbContext context, BaseEntity baseEntity)
        {
            context.Entry(baseEntity).Property(x => x.UpdatedAt).IsModified = false;
            baseEntity.CreatedAt = DateTime.Now;
        }

        private static void ModifieddBehavior(DbContext context, BaseEntity baseEntity)
        {
